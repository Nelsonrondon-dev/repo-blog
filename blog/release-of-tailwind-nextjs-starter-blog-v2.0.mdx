...
Welcome to change cambio 2  

<details className="orange-content dark:bg-zinc-800/95 rounded-lg p-2" open>
<summary className="ml-3 text-xl font-bold cursor-pointer">Tabla de contenidos</summary>
<div className="ml-4 mb-6 mt-4">
